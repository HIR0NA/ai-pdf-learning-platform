    ...
    <div className={styles.container}>
      ...
      <div className={styles.faqSection}>
        ...
        <div className={styles.faqGrid}>
          {[
            { q: 'ใช้งาน AgentAI ได้ฟรีหรือไม่?', a: 'เรามีแพ็กเกจ Basic ให้คุณทดลองใช้งานฟรี! โดยสามารถอัปโหลดไฟล์ขนาดไม่เกิน 5MB ได้ครับ' },
            { q: 'ข้อมูลของฉันจะปลอดภัยไหม?', a: 'ปลอดภัย 100% ครับ เราไม่ได้นำข้อมูลเอกสารของคุณไปฝึกฝน AI ต่อ และคุณสามารถลบเอกสารออกจากระบบได้ตลอดเวลา' },
